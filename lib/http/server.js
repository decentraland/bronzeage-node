/*!
 * server.js - http server for decentraland
...
HTTPServer.prototype._init = function _init() {
  ...
  this.opt('/', function(req, res, send, next) {
  });
...
HTTPServer.prototype.opt = function opt(path, callback) {
  return this.server.opt(path, callback, this);
};
