/*!
 * masterkey.js - master bip32 key object for decentraland
...
var DECENTRALAND_SALT = new Buffer('decentraland', 'ascii');
...
MasterKey.prototype.derive = function derive(passwd) {
  ...
  switch (this.alg) {
    case MasterKey.alg.PBKDF2:
      return crypto.pbkdf2Async(passwd, DECENTRALAND_SALT, this.N, 32, 'sha256');
    case MasterKey.alg.SCRYPT:
      return crypto.scryptAsync(passwd, DECENTRALAND_SALT, this.N, this.r, this.p, 32);
    default:
