/*!
 * workerpool.js - worker processes for decentraland
...
function Worker(id) {
  ...
  this.pending = {};
  this.env = {
    DECENTRALAND_WORKER_NETWORK: Network.type,
    DECENTRALAND_WORKER_ISTTY: process.stdout
...
Worker.prototype._initWebWorkers = function _initWebWorkers() {
  ...
  this.child = new global.Worker('/decentraland-worker.js');
...
exports.set({
  useWorkers: +process.env.DECENTRALAND_USE_WORKERS === 1,
  maxWorkers: +process.env.DECENTRALAND_MAX_WORKERS,
  workerTimeout: +process.env.DECENTRALAND_WORKER_TIMEOUT
});
